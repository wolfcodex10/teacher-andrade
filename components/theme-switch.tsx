...
export default function ThemeSwitch() {
  ...
  return (
    <div className="fixed bottom-5 right-5 flex flex-col gap-3">
      <button className=" bg-[#25D366] w-[3rem] h-[3rem] bg-opacity-80 backdrop-blur-[0.5rem] border border-white border-opacity-40 shadow-2xl rounded-full flex items-center justify-center hover:scale-[1.15] active:scale-105 transition-all dark:bg-[#26a856]">
        <BsWhatsapp />
      </button>
      <button
