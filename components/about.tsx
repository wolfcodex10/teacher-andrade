      ...
      >
        ...
        <div className="md:max-w-[50%] px-8 w-full">
          ...
          <p className="mb-3">
            ...
            Letras - Inglês e Português, com certificação internacional CELTA.
            Sou casado e pai de 2 filhos e, por alguns anos da minha vida,
            também fui músico profissional.
          </p>
          ...
          <p className="mb-6">
            ...
            apaixonado pelo que faço e acredito que essa paixão é essencial para
            o sucesso no ensino. Minhas aulas são pensadas para criar um
            ambiente leve e descontraído, onde cada aluno se sinta à vontade e
            relaxado, favorecendo assim a aprendizagem.
          </p>
          <div className="flex flex-col md:flex-row items-center gap-3">
            ...
            <button
              ...
              className="relative inline-block p-px font-semibold leading-6 text-white no-underline bg-gray-800 shadow-lg dark:shadow-2xl cursor-pointer group rounded-xl dark:shadow-zinc-900"
            >
              <span className="absolute inset-0 overflow-hidden rounded-xl">
                <span className="absolute inset-0 rounded-xl bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(56,189,248,0.6)_0%,rgba(56,189,248,0)_75%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100"></span>
              </span>
